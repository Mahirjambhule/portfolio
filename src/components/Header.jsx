...
export const Header = () => {
    ...
    return (
        <header className="fixed top-0 w-full bg-gray-950/95 border-b border-gray-800 z-50">
            ...
            {isMenuOpen && (
                <div className="md:hidden bg-gray-900 border-b border-gray-800 p-4 space-y-4 animate-in slide-in-from-top-5 duration-200">
                    {navItems.map(item => (
                        <a
                            key={item.name}
                            href={item.href}
                            className="block hover:text-blue-400 text-gray-300"
